  ...
  const renderTokenSection = () => {
    ...
    if (account && !hasProfile) {
      if (publicIfoData.status === 'finished') {
        return <Text textAlign="center">{t('Activate Glenty Profile to take part in next IFO‘s!')}</Text>
      }
      return <Text textAlign="center">{t('You need an active Glenty Profile to take part in an IFO!')}</Text>
    }
    ...
    if (publicIfoData.status === 'live') {
      return (
        <>
          <TokenSection img="/images/farms/cake-bnb.png" mb="24px">

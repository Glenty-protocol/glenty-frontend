    ...
    switch (step) {
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              {t('You’ll need an active Glenty Profile to take part in an IFO!')}
            </Text>
            {isStepValid ? (
      ...
      case 1:
        return (
          <CardBody>
            <Heading as="h4" color="secondary" mb="16px">
              {t('Get GLENTY-BNB LP Tokens')}
            </Heading>
            <Text color="textSubtle" small>
              {t('Stake GLENTY and BNB in the liquidity pool to get LP tokens.')} <br />
              {t('You’ll spend them to buy IFO sale tokens.')}
            </Text>
            <Button
              as={Link}
              external
              href={`${BASE_ADD_LIQUIDITY_URL}/BNB/0x97769506e36988d08745b64e78f66e37858f14e9`}
      ...
      case 3:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t(
                'After the IFO sales finish, you can claim any IFO tokens that you bought, and any unspent GLENTY-BNB LP tokens will be returned to your wallet.',
              )}
            </Text>
          </CardBody>
        )

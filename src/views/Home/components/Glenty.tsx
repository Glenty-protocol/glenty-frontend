...
const Glenty = () => {
  ...
  return (
    <div style={{ backgroundColor: 'rgba(49,39,131,0.9)', borderRadius: '24px' }}>
      <Heading scale="xl" mb="24px" className='buyGlenty' style={{ display: 'flex', backgroundColor: 'rgba(120,140,255,0.9)', borderRadius: '24px 24px 0px 0px', justifyContent: 'space-between' }}>
      ...
      <div style={{ display: 'flex', padding: '24px', justifyContent: "space-around" }}>
        ...
        }} onKeyDown={() => console.log('amount of tokens:', count)} style={{ backgroundColor: '#FFCC33', borderRadius: '24px', color: 'white', cursor: 'pointer', fontSize: '18px', textAlign: 'center', margin: '20px 2px 20px auto', padding: '12px'}}>BUY GLENTY</div>
        </div>
      </div>
    </div>
  )

...
/*nav*/
    ...
    priceMLink.classList.add('sc-bXexck');
    priceMLink.classList.add('cDLKlO');
...
/*price*/
    ...
    priceMDiv.classList.add('iaNuVq');
    priceMDiv.classList.add('sc-gtsrHT');
...
function farmPage(){
  ...
  window.location.href.includes('farms')?document.querySelector('.farmFilter').style.marginRight = '-12%':false
...
function gigapoolPage(){
  document.querySelector('.glgFiQ').remove();
